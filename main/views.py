...
BASE_CONTEXT = {
    ...
    "stats": [
        {"number": "18+", "label": "Portfolio Samples"},
        {"number": "6+", "label": "Core Services"},
        {"number": "24/7", "label": "Client Response"},
    ],
    "reasons": [
    ...
    "testimonials": [
        {"name": "Client Review", "text": "Fabulous service. Strong creativity, clear communication, and professional delivery."},
        {"name": "Business Owner", "text": "Our brand looked more serious and more premium after the redesign."},
        {"name": "Marketing Client", "text": "The final visuals were clean, strategic, and exactly what we needed."},
    ],
}
